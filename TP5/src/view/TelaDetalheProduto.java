	...
	public TelaDetalheProduto (ControleProdutos cprodutos, int op, int index){
		switch (op){
			case 1:
				...
				sets(detalhePastel);//chama a fun̤̣o que configura o JFrame
				...
				excluir.addActionListener(e->{
					...
					int resposta= JOptionPane.showOptionDialog( null, "Deseja excluir?","Confirma̤̣o",  JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null, options, options[1] );
		            if(resposta == JOptionPane.YES_OPTION){
		            	cprodutos.excluirPastel(index);//chama a fun̤ao que exclui o pastel dos dados
