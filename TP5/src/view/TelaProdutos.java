...
public class TelaProdutos {
	...
	public void sets(JFrame f) {//configuraÃ§Ãµes padrao da janela
		f.setSize(400, 350);
	...
	public void JanelaPastel() {
		...
		sets(detalheProduto);
		JList<Object> listaPastel = new JList<Object>(cprodutos.getNamesPastel());//chama a funÃ§Ã£o que passa os nomes dos pasteis
	...
	public void JanelaBebida() {
		...
		sets(detalheBebida);
		JList<Object> listaBebida = new JList<Object>(cprodutos.getNamesBebida());//chama a funÃ§Ã£o que passa os nomes das bebidas
	...
	public void JanelaPesquisaPastel() {
		...
		ok.addActionListener(j ->{
			if(cprodutos.pesquisarNomesPastel(nomePesquisa.getText()) != -1) {
				...
				JOptionPane.showMessageDialog(null, "O Pastel não foi encontrado", "Pesquisa", JOptionPane.CLOSED_OPTION);
				janelaPesquisa.dispose();
			}	
		});
	}
	public void JanelaPesquisaBebida() {
		...
		ok.addActionListener(j ->{
			if(cprodutos.pesquisarNomesBebida(nomePesquisa.getText()) != -1) {
				...
				JOptionPane.showMessageDialog(null, "A Bebida não foi encontrado", "Pesquisa", JOptionPane.CLOSED_OPTION);
				janelaPesquisa.dispose();
			}	
		});
	}
